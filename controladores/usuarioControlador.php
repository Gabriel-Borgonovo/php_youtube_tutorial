<?php
    ...
    class usuarioControlador extends usuarioModelo{
        ...
        public function agregar_usuario_controlador(){
            ...
            if($agregar_usuario->rowCount()==1){
                ...
                $alerta=[
					"Alerta"=>"simple",
					"Titulo"=>"Ocurrió un error inesperado",
					"Texto"=>"No hemos podido registrar el usuario en la BBDD",
					"Tipo"=>"error"
				];
            }
            echo json_encode($alerta);
        ...
        public function paginador_usuario_controlador($pagina, $registros, $privilegio, $id, $url, $busqueda){
            ...
            if($total>=1 && $pagina<=$Npaginas){
                $tabla.='<p class="text-right">Mostrando usuarios '.$reg_inicio.' al '.$reg_final.'
        ...
        public function eliminar_usuario_controlador(){
            ...
            /** comprobando el usuario en la BBDD */
            $check_usuario=mainModel::ejecutar_consulta_simple(
                "SELECT usuario_id FROM usuario WHERE usuario_id='$id'"
            ); 
            ...
            if($check_prestamos->rowCount()>0){
                $alerta=[
                    "Alerta"=>"simple",
                    "Titulo"=>"Ocurrió un error inesperado",
                    "Texto"=>"No podemos eliminar este usuario debido a que tiene prestamos asociados, recomendamos deshabilitar el usuario si ya no será utilizado",
                    "Tipo"=>"error"
                ];
                echo json_encode($alerta);
                exit();
        ...
        public function datos_usuario_controlador($tipo,$id){
         ...
         public function actualizar_usuario_controlador(){
            ...
            //comprobar el usuario en la BBDD
