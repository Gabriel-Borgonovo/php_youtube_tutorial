						...
						<div class="form-group">
							<select class="form-control" name="usuario_privilegio_up">
								<option value="1" <?php if($campos['usuario_privilegio']==1){ echo 'selected=""'; } ?> >
									Control total <?php if($campos['usuario_privilegio']==1){ echo '(Actual)'; } ?> 
								</option>

								<option value="2" <?php if($campos['usuario_privilegio']==2){ echo 'selected=""'; } ?> >
									Edición <?php if($campos['usuario_privilegio']==2){ echo '(Actual)'; } ?> 
								</option>

								<option value="3" <?php if($campos['usuario_privilegio']==3){ echo 'selected=""'; } ?> >
									Registrar <?php if($campos['usuario_privilegio']==3){ echo '(Actual)'; } ?> 
								</option>
							</select>
						</div>
					</div>
					...
					<div class="col-12 col-md-6">
						<div class="form-group">
							...
							<input 
								type="text" 
								pattern="[a-zA-Z0-9]{1,35}" 
								class="form-control" name="usuario_admin" 
								id="usuario_admin"
								maxlength="35" 
								required="" 
							/>
